...
module.exports.purchase = async (req, res) => {
  ...
  var price = (pre_order.price + 0.3) / (1 - 0.066);
  price = price.toFixed(2);
  order.price_final = price;
  var comish = order.price - price;
...
module.exports.carrito = async (req, res) => {
  ...
  var price = (pre_order.price + 0.3) / (1 - 0.59);
  price = price.toFixed(2);
...
module.exports.RapidOrder = async (req, res) => {
  ...
  var price = (order.price + 0.3) / (1 - 0.059);
  price = price.toFixed(2);
  order.price_final = price;
  var transaction_fee = (order.price + 0.3) / (1 - 0.059) - order.price;
